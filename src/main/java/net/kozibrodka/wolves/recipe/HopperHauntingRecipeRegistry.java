...
public class HopperHauntingRecipeRegistry {
    private static final HopperHauntingRecipeRegistry INSTANCE = new HopperHauntingRecipeRegistry();
    private Map recipes = new HashMap();

    public static final HopperHauntingRecipeRegistry getInstance() {
        return INSTANCE;
    }

    public void addHopperHauntingRecipe(int i, ItemInstance arg) {

...
public class MillingRecipeRegistry {
    ...
    public ArrayList<MillStoneRecipeWrapperWrapper> getRecipes() {
        ArrayList<MillStoneRecipeWrapperWrapper> convertedRecipes = new ArrayList<>();
        ...
        for (int i = 0; i < inputs.size(); i++) {
            ...
            convertedRecipes.add(new MillStoneRecipeWrapperWrapper(inputs.get(i), outputs.get(i)));
        }

...
public class WaterWheelEntityOld extends Entity implements EntitySpawnDataProvider
{

    public WaterWheelEntityOld(World world)
    {
        super(world);
...
//        setAligned(true);
    ...
    public WaterWheelEntityOld(World level, Double aDouble, Double aDouble1, Double aDouble2) {
        this(level);
    }

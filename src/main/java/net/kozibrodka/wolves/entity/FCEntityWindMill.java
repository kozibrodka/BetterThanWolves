...
//
//public class FCEntityWindMill extends Living
//{
//
...
//        if(!removed)
//        {
//            dropItemWithOffset(mod_FCBetterThanWolves.fcWindMillItem.id, 1, 0.0F);
//            remove();
//        }
//    }
//
...
//    {
//        ItemInstance ItemInstance = entityplayer.inventory.getCurrentItem();
...
//            {
//                iColor = Wool.func_21033_c(ItemInstance.getDamage());
//            } else
//            {
//                iColor = 12;
//            }
...
//            {
//                entityplayer.inventory.setInventoryItem(entityplayer.inventory.currentItem, null);
//            }
//        }
//        return true;
//    }
...
//        if(level.worldProvider.isHellWorld)
//        {
//            fRotationAmount = -0.0675F;
//            iOverpowerTimer = -1;
//        } else
//        if(level.canBlockSeeTheSky(iCenterI, iCenterJ, iCenterK))
//        {

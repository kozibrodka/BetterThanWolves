...
//                                  better_than_canis_lupus.mod.FCEntityMovingAnchor entityMovingAnchor)
//    {
//        this(world);
...
//        better_than_canis_lupus.mod.FCEntityMovingAnchor associatedMovingAnchor = null;
//        List list = level.getEntities(better_than_canis_lupus.mod.FCEntityMovingAnchor.class, Box.createButWasteMemory(m_AssociatedAnchorLastKnownXPos - 0.25D, m_AssociatedAnchorLastKnownYPos - 0.25D, m_AssociatedAnchorLastKnownZPos - 0.25D, m_AssociatedAnchorLastKnownXPos + 0.25D, m_AssociatedAnchorLastKnownYPos + 0.25D, m_AssociatedAnchorLastKnownZPos + 0.25D));
//        if(list != null && list.size() > 0)
//        {
//            associatedMovingAnchor = (better_than_canis_lupus.mod.FCEntityMovingAnchor)list.get(0);
...
//        double newPosY = y;
//        list = level.getEntitiesWithinAABBExcludingEntity(this, boundingBox.expand(0.0D, 0.14999999999999999D, 0.0D));
//        if(list != null && list.size() > 0)
//        {
...
//                    continue;
//                }
//                if(entity instanceof better_than_canis_lupus.mod.FCEntityWindMill)
//                {
//                    better_than_canis_lupus.mod.FCEntityWindMill entityWindMill = (better_than_canis_lupus.mod.FCEntityWindMill)entity;
...
//                {
//                    if(!BlockBase.BY_ID[iTargetid].blockMaterial.isSolid())
//                    {
...
//    }
//
//    private void ConvertToBlock(int i, int j, int k, better_than_canis_lupus.mod.FCEntityMovingAnchor associatedAnchor)
//    {

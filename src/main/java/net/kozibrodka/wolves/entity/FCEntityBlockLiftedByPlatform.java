...
public class FCEntityBlockLiftedByPlatform extends EntityBase
{

    public FCEntityBlockLiftedByPlatform(Level world)
    {
        super(world);
        field_1593 = true;
        setSize(0.98F, 0.98F);
    ...
    public FCEntityBlockLiftedByPlatform(Level world, int i, int j, int k)
    {
        this(world);
    ...
    public void tick()
    {
        ...
        List collisionList = level.getEntities(FCEntityMovingPlatform.class, Box.createButWasteMemory(x - 0.25D, y - 1.25D, z - 0.25D, x + 0.25D, y - 0.75D, z + 0.25D));

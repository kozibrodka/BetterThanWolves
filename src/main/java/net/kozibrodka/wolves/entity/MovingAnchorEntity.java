...
public class MovingAnchorEntity extends Entity implements EntitySpawnDataProvider
{
    ...
    public void tick()
    {
        ...
        {
            tileEntityPulley = (PulleyBlockEntity)world.method_1777(associatedPulleyPos.i, associatedPulleyPos.j, associatedPulleyPos.k);
            if(velocityY > 0.0D)
            {
    ...
    public boolean ReturnRopeToPulley()
    {
        ...
        {
            PulleyBlockEntity tileEntityPulley = (PulleyBlockEntity)world.method_1777(associatedPulleyPos.i, associatedPulleyPos.j, associatedPulleyPos.k);
            if(tileEntityPulley != null)
            {

...
public class FCEntityBroadheadArrow extends EntityBase{
    ...
    public FCEntityBroadheadArrow(Level arg) {
        super(arg);
        this.setSize(0.5F, 0.5F);
    }

    public FCEntityBroadheadArrow(Level arg, double d, double e, double f) {
        super(arg);
        this.setSize(0.5F, 0.5F);
    ...
    public FCEntityBroadheadArrow(Level arg, Living arg2) {
        super(arg);
        this.owner = arg2;

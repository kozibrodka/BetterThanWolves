...
//public class WindMillEntityAtilist extends Entity implements EntitySpawnDataProvider {
//
//    public WindMillEntityAtilist(World world) {
//        super(world);
...
//    }
//
//    public WindMillEntityAtilist(World world, double x, double y, double z, boolean bIAligned) {
//        this(world);
//        setPosition(x, y, z);
...
//    }
//
//    public WindMillEntityAtilist(World level, Double aDouble, Double aDouble1, Double aDouble2) {
//        this(level);
//    }
//

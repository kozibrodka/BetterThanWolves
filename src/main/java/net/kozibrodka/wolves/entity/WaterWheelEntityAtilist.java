...
//public class WaterWheelEntityAtilist extends Entity implements EntitySpawnDataProvider {
//
//    public WaterWheelEntityAtilist(World world) {
//        super(world);
...
//    }
//
//    public WaterWheelEntityAtilist(World world, double x, double y, double z, boolean bJAligned) {
//        this(world);
//        setPosition(x, y, z);
//        setAligned(bJAligned);
//    }
//
//    public WaterWheelEntityAtilist(World level, Double aDouble, Double aDouble1, Double aDouble2) {
//        this(level);
//    }
//
...
//                return;
//            }
//            if (!getProvidingPower() && ((AxleBlock) BlockListener.axleBlock).setPowerLevel(world, centerX, centerY, centerZ) > 0) {
//                destroyWithDrop();
//                return;
//            }
//            if (!getProvidingPower() && ((AxleBlock) BlockListener.nonCollidingAxleBlock).setPowerLevel(world, centerX, centerY, centerZ) > 0) {
//                destroyWithDrop();
//                return;
//            }
...
//    }
//
//    public static boolean isSuitableBlock(@NotNull World world, int x, int y, int z) {
...
//                } else if (flowVector.z < -0.33000001311302185D) {
//                    fRotationAmount = 0.25F;
//                }
//            } else if (flowVector.x > 0.33000001311302185D) {
//                fRotationAmount = 0.25F;
//            } else if (flowVector.x < -0.33000001311302185D) {
//                fRotationAmount = -0.25F;
//            }

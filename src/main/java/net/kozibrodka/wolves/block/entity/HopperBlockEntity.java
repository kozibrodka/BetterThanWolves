        ...
        if(itemIndex >= 0 && itemIndex < 18)
        {
            ...
            } else
            {
                ...
                } else
                {
                    ...
                    {
                        BlockEntity targetTileEntityBase = world.method_1777(iTargetI, iTargetJ, iTargetK);
                                ...
                                if(!InventoryHandler.addItemWithinSlotBounds((Inventory)targetTileEntityBase, ejectStack, iMinSlotToAddTo, iMaxSlotToAddTo))
                                {
                                    if(iTargetid == Block.CHEST.id)
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            {
                                                targetTileEntityBase = world.method_1777(iTargetI + tempOffset.i, iTargetJ + tempOffset.j, iTargetK + tempOffset.k);
                                                if(targetTileEntityBase != null && (targetTileEntityBase instanceof Inventory))
                                                {

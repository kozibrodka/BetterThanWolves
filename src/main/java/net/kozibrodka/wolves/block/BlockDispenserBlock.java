    ...
    implements RotatableBlock
{
    ...
    public boolean onUse(World world, int i, int j, int k, PlayerEntity entityplayer) {
        ...
        BlockDispenserBlockEntity tileEntityBlockDispenser = (BlockDispenserBlockEntity)world.method_1777(i, j, k);
    ...
    {
        ValidateBlockDispenser(world, i, j, k);
        BlockDispenserBlockEntity tileEentityDispenser = (BlockDispenserBlockEntity)world.method_1777(i, j, k);
    ...
    private void ConsumeFacingBlock(World world, int i, int j, int k)
    {
        ...
        if(!ConsumeEntityAtTargetLoc(world, i, j, k, targetPos.i, targetPos.j, targetPos.k) && !world.method_234(targetPos.i, targetPos.j, targetPos.k))
        {
            ...
            if(targetBlock != null && IsBlockConsumable(targetBlock))
            {
                ...
                if(iTargetid == id)
                {
                    BlockDispenserBlockEntity targetTileEentityDispenser = (BlockDispenserBlockEntity)world.method_1777(targetPos.i, targetPos.j, targetPos.k);
                ...
                } else
                {
                    ...
                    if(newBlock != null)
                    {
                        ...
                        if(world.method_156(iNewid, targetPos.i, targetPos.j, targetPos.k, true, iTargetDirection))
                        {
                            ...
                            {
                                world.method_201(targetPos.i, targetPos.j, targetPos.k, iNewid, iteminstance.getItem().method_470(iteminstance.getDamage()));

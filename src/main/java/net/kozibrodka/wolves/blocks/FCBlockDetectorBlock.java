...
public class FCBlockDetectorBlock extends TemplateBlockBase
    implements FCIBlock
{

    public FCBlockDetectorBlock(Identifier iid)
    {
    ...
    {
        if((entity instanceof Arrow) || (entity instanceof FCEntityBroadheadArrow))
        {
            int iFacingDirection = GetFacing(world, i, j, k);
            int targeti = i;
            int targetj = j;

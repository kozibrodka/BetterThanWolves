    ...
    implements FCIBlock
{
    ...
    public boolean canUse(Level world, int i, int j, int k, PlayerBase entityplayer)
    {
            ...
            GuiHelper.openGUI(entityplayer, Identifier.of("wolves:openBlockDispenser"), (InventoryBase) tileEntityBlockDispenser, new BlockDispenserContainer(entityplayer.inventory, (FCTileEntityBlockDispenser) tileEntityBlockDispenser));
            return true;
    }

...
public class ScreenPacket extends Packet implements IdentifiablePacket {
    ...
    public void handleServer(NetworkHandler networkHandler){
        ...
        if(Objects.equals(tile, "mill")){
            MillStoneBlockEntity tile = (MillStoneBlockEntity) player.world.method_1777(this.x,this.y,this.z);
            if(tile != null) {
        ...
        if(Objects.equals(tile, "crucible")){
            CrucibleBlockEntity tile = (CrucibleBlockEntity) player.world.method_1777(this.x,this.y,this.z);
            if(tile != null) {
        ...
        if(Objects.equals(tile, "cauldron")){
            CauldronBlockEntity tile = (CauldronBlockEntity) player.world.method_1777(this.x,this.y,this.z);
            if(tile != null) {
        ...
        if(Objects.equals(tile, "dispenser")){
            BlockDispenserBlockEntity tile = (BlockDispenserBlockEntity) player.world.method_1777(this.x,this.y,this.z);
            if(tile != null) {

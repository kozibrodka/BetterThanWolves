...
public class FCContainerBlockDispenser extends ContainerBase
{

    public FCContainerBlockDispenser(InventoryBase iinventory, FCTileEntityBlockDispenser tileEntityBlockDispenser)
    {

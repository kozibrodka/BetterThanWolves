...
public class FCContainerCrucible extends ContainerBase
{

    public FCContainerCrucible(InventoryBase playerinventory, FCTileEntityCrucible tileEntityCrucible)
    {

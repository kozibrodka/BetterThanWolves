...
public class FCContainerMillStone extends ContainerBase
{

    public FCContainerMillStone(InventoryBase playerinventory, FCTileEntityMillStone tileentityMillStone)
    {

...
public class CauldronSingleRecipeTab extends TabWithTexture {
    ...
    public CauldronSingleRecipeTab(Namespace tabCreator) {
        this(tabCreator, new ArrayList<ItemStack[]>(CauldronCraftingManager.getInstance().getSingleRecipes()), BlockListener.cauldron);
    }

    public CauldronSingleRecipeTab(Namespace tabCreator, List<ItemStack[]> recipesReady, Block tabBlock) {
        this(tabCreator, 2, recipesReady, tabBlock, "/assets/wolves/stationapi/gui/hmi_tabs/one_in_one_out.png", 140, 56, 22, 15);
    }

    public CauldronSingleRecipeTab(Namespace tabCreator, int slotsPerRecipe, List<ItemStack[]> recipesReady, Block tabBlock, String texturePath, int width, int height, int textureX, int textureY) {

...
public class CauldronStokedSingleRecipeTab extends TabWithTexture {
    ...
    public CauldronStokedSingleRecipeTab(ModID tabCreator) {
        this(tabCreator, new ArrayList<ItemInstance[]>(FCCraftingManagerCauldronStoked.getInstance().getSingleRecipes()), mod_FCBetterThanWolves.fcCauldron);
    }
    ...
    public CauldronStokedSingleRecipeTab(ModID tabCreator, int slotsPerRecipe, List<ItemInstance[]> recipesReady, BlockBase tabBlock, String texturePath, int width, int height, int textureX, int textureY) {
